...
namespace University_Diploma
{
    public static class Prompt
    {
        public static string ShowDialog(string Text, string Caption)
        {
            ...
            Label TextLabel = new Label() { /*Left = 50, Top = 20,*/ Text = Text, Width = 300, Font = Font, ForeColor = White };
            TextBox TextBox = new TextBox() { /*Left = 50, Top = 50, */Width = 284, BackColor = Black, Font = Font, ForeColor = White };
            Button Confirmation = new Button() { Text = "OK", /*Left = 350, Top = 70,*/ Left = 100, Top = 24, Width = 100, 
